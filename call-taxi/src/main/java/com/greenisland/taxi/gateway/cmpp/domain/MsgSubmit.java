...
import com.greenisland.taxi.gateway.cmpp.util.MsgUtils;
 ...
 * @version 2013-8-26下午1:55:47
 */
public class MsgSubmit extends MsgHead {
	private static Logger logger = Logger.getLogger(MsgSubmit.class);
	private long msgId = 0;// 信息标识
	private byte pkTotal = 0x01;// 短信长度超过单挑短信，则被拆分多条，此参数是记录拆分短信的条数。
	private byte pkNumber = 0x01;// 编号决定消息的相对位置
	...
	private String feeCode = "000000";// 资费代码0050代表人民币0.50元
	...
	public byte[] toByteArray() {
		...
		try {
			...
			MsgUtils.writeString(dous, this.feeTerminalId, 21);// Fee_terminal_Id
																// 被计费用户的号码
